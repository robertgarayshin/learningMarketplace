package ru.edu.marketplace.app.config;
...
@Getter
@Configuration
@MapperScan(basePackages = {"ru.edu.marketplace.app.repository.write", "ru.edu.marketplace.app.repository.read"})
public class DataConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryWrite() throws Exception {
        ...
        sqlSessionFactory.setTypeAliasesPackage("ru.edu.marketplace.app.entity");

        List<String> mappers = new ArrayList<>();
        mappers.add("classpath*:ru/edu/marketplace/app/repository/write/*.xml");
        mappers.add("classpath*:ru/edu/marketplace/app/repository/read/*.xml");
